...
namespace PracticaMVC.Controllers
{
    public class Estados_reservaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("estado_res_id,estado,en_uso")] estados_reserva estados_reserva)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("estado_res_id,estado,en_uso")] estados_reserva estados_reserva)
        {
